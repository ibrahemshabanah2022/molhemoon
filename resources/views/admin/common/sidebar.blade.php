            ...
            @can('manage_subscriptions')
                <li class="{{ @$navSubscriptionParentActiveClass }}">
                    ...
                    <ul class="{{ @$navSubscriptionParentShowClass }}">
                        ...
                        <li
                            class="{{ request()->route()->getName() == 'admin.subscriptions.create' ? 'mm-active' : '' }}">
                        ...
                        <li
                            class="{{ request()->route()->getName() == 'admin.subscriptions.purchase_list' ? 'mm-active' : '' }}">
            ...
            @can('manage_wallet_recharge')
                <li class="{{ @$navWalletParentActiveClass }}">
                    ...
                    <ul class="{{ @$navWalletParentShowClass }}">
                        ...
                        <li
                            class="{{ request()->route()->getName() == 'admin.wallet_recharge.list' ? 'mm-active' : '' }}">
            ...
            @can('manage_saas')
                <li class=" {{ @$navSaasParentActiveClass }} ">
                    ...
                    <ul class="{{ @$navSaasParentShowClass }}">
                        ...
                        <li
                            class="{{ request()->route()->getName() == 'admin.saas.purchase_pending_list' ? 'mm-active' : '' }}">
        ...
        @can('manage_blog')
            <li class="{{ @$navBlogParentActiveClass }}">
                ...
                <ul>
                    ...
                    <li
                        class="{{ active_if_full_match('admin/blog') }} {{ active_if_full_match('admin/blog/edit/*') }}">

...
@section('content')
                        ...
                        <div class="breadcrumb__content__right">
                            <nav aria-label="breadcrumb">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a
                                            href="{{ route('coupon.index') }}">{{ __('Coupon List') }}</a></li>
                    ...
                    <div class="customers__area bg-style mb-30">
                        ...
                        <form action="{{ route('coupon.store') }}" method="post" class="form-horizontal">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <div class="input__group text-black">
                                        ...
                                        <input type="text" name="coupon_code_name" value="{{ old('coupon_code_name') }}"
                                            placeholder="{{ __('Type coupon code name') }}" class="form-control" required>
                                        @if ($errors->has('coupon_code_name'))
                                            <span class="text-danger"><i class="fas fa-exclamation-triangle"></i>
                                                {{ $errors->first('coupon_code_name') }}</span>
                                        @endif
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 d-none" id="instructor_id_div">
                                <div class="col-md-12">
                                    <div class="input__group">
                                        ...
                                        <select name="instructor_ids[]" multiple id="instructor_ids"
                                            class="multiple-basic-single">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <div class="input__group text-black">
                                        <label>Discount (Percentage %)(ex: 15, 25, 30, 40 ...)<span
                                                class="text-danger">*</span></label>
                                        <input type="number" min="0" step="any" name="percentage"
                                            value="{{ old('percentage') }}" placeholder="%" class="form-control" required>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <div class="input__group text-black">
                                        <label>{{ __('Minimum Amount to Apply Coupon') }}<span
                                                class="text-danger">*</span></label>
                                        <input type="number" min="0" name="minimum_amount"
                                            value="{{ old('minimum_amount') }}"
                                            placeholder="{{ __('Type minimum amount') }}" class="form-control" required>
                                        @if ($errors->has('minimum_amount'))
                                            <span class="text-danger"><i class="fas fa-exclamation-triangle"></i>
                                                {{ $errors->first('minimum_amount') }}</span>
                                        @endif
                                    </div>
                                </div>
                            </div>
    ...
    <form method="POST" action="{{ route('internships.store') }}">
        ...
        <input type="text" id="experience_needed" name="experience_needed"><br>

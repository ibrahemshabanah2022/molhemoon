                ...
                <div class="col-md-7">
                    <div class="sign-up-right-content bg-white">
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <p class="font-14 mb-30">{{ __('New User') }} ? <a href="{{ route('sign-up') }}"
                            ...
                            <div class="row mb-30">
                                <div class="col-md-12">
                                    <label
                                        class="label-text-title color-heading font-medium font-16 mb-3">{{ __('Email or Phone') }}</label>
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-md-12">
                                            <a href="{{ route('login.google') }}"
                                                class="theme-btn theme-button1 theme-button3 font-15 fw-bold w-100 google-login">{{ __('Sign in with Google') }}</a>
                                        </div>
                                    </div>
                                @endif
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-md-12">
                                            <a href="{{ route('login.facebook') }}"
                                                class="theme-btn theme-button1 theme-button3 font-15 fw-bold w-100 facebook-login">{{ __('Sign in with Facebook') }}</a>
                                        </div>
                                    </div>
                                @endif
                                ...
                                @if (env('LOGIN_HELP') == 'active')
                                    <div class="table-responsive login-info-table mt-3">
                                        <table class="table table-bordered">
                                            <tbody>
                                                <tr>
                                                    <td id="adminCredentialShow" class="login-info"><b>Admin:</b>
                                                        admin@gmail.com | 123456</td>
                                                    <td id="instructorCredentialShow" class="login-info"><b>Instructor:</b>
                                                        instructor@gmail.com | 123456</td>
                                                </tr>
                                                <tr>
                                                    <td id="studentCredentialShow" class="login-info"><b>Student:</b>
                                                        student@gmail.com | 123456</td>
                                                    <td id="affiliatorCredentialShow" class="login-info"><b>Affiliator:</b>
                                                        affiliator@gmail.com | 123456</td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2" id="organizationCredentialShow" class="login-info">
                                                        <b>Organization:</b> organization@gmail.com | 123456
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>

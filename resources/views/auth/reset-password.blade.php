                    ...
                    <div class="sign-up-right-content bg-white">
                        <form action="{{ route('reset-password') }}" method="post">
                            ...
                            <div class="row mb-30">
                                <div class="col-md-12">
                                    <label
                                        class="label-text-title color-heading font-medium font-16 mb-3">{{ __('Verification Code') }}</label>
                                    <div class="form-group mb-0 position-relative">
                                        <input class="form-control " name="verification_code"
                                            placeholder="{{ __('Type your verification code') }}" type="number" required>
                                    </div>
                                    @if ($errors->has('verification_code'))
                                        <span class="text-danger"><i class="fas fa-exclamation-triangle"></i>
                                            {{ $errors->first('verification_code') }}</span>
                                    @endif
                                </div>
                            </div>
                            <div class="row mb-30">
                                <div class="col-md-12">
                                    <label
                                        class="label-text-title color-heading font-medium font-16 mb-3">{{ __('New Password') }}</label>
                                    <div class="form-group mb-0 position-relative">
                            ...
                            <div class="row mb-30">
                                <div class="col-md-12">
                                    <label
                                        class="label-text-title color-heading font-medium font-16 mb-3">{{ __('Confirm Password') }}</label>
                                    <div class="form-group mb-0 position-relative">
                            ...
                            <div class="row mb-30">
                                <div class="col-md-12">
                                    <button type="submit"
                                        class="theme-btn theme-button1 theme-button3 font-15 fw-bold w-100">{{ __('Change Password') }}</button>
                                </div>
                            </div>
                            <div class="row mb-30">

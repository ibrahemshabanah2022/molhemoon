                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="section-left-title-with-btn d-flex justify-content-between align-items-end">
                                <div class="section-title section-title-left d-flex align-items-start">
                                    <div class="section-heading-img"><img
                                            src="{{ getImageFile(get_option('category_course_logo')) }}"
                                            alt="Category Course"></div>
                                    <div>
                                ...
                                <div class="section-left-title-with-btn d-flex justify-content-between align-items-end">
                                    <div class="section-title section-title-left d-flex align-items-start">
                                        <div class="section-heading-img"><img class="w-60px"
                                                src="{{ getImageFile(get_option('product_section_logo')) }}"
                                                alt="Product"></div>
                                        <div>
                                            ...
                                            <p class="section-sub-heading">
                                                {{ __(get_option('product_section_subtitle')) }}</p>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="section-left-title-with-btn d-flex justify-content-between align-items-end">
                                    <div class="section-title section-title-left d-flex align-items-start">
                                        <div class="section-heading-img"><img
                                                src="{{ getImageFile(get_option('bundle_course_logo')) }}"
                                                alt="Course"></div>
                                        <div>
                                            <h3 class="section-heading">{{ __(get_option('bundle_course_title')) }}</h3>
                                            <p class="section-sub-heading">{{ __(get_option('bundle_course_subtitle')) }}
                                            </p>
                                        </div>
                                    </div>
                        ...
                        <div class="col-12">
                            <div class="section-title text-center">
                                ...
                                <h3 class="section-heading section-heading-light">
                                    {{ __(get_option('top_category_title')) }}</h3>
                    ...
                    <div class="row top-categories-content-wrap">
                        ...
                        @if (!get_option('private_mode') || !auth()->guest())
                            ...
                            <div class="col-12 text-center section-btn">
                                <a href="{{ route('courses') }}"
                                    class="theme-btn theme-button1">{{ __('All Categories') }} <i
                                        data-feather="arrow-right"></i></a>
                            </div>
                            <!-- section button end-->
                        @endif
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="section-left-title-with-btn d-flex justify-content-between align-items-end">
                            <div class="section-title section-title-left d-flex align-items-start">
                                <div class="section-heading-img"><img
                                        src="{{ getImageFile(get_option('upcoming_course_logo')) }}" alt="Course">
                                </div>
                                <div>
                        ...
                        <div class="col-md-4">
                            <div class="testimonial-item">
                                ...
                                <div class="testimonial-bottom-content">
                                    ...
                                    <p class="font-17">{{ __(get_option('customer_say_first_comment_description')) }}
                                    </p>
                        ...
                        <div class="col-md-4">
                            <div class="testimonial-item">
                                ...
                                <div class="testimonial-bottom-content">
                                    ...
                                    <p class="font-17">{{ __(get_option('customer_say_second_comment_description')) }}
                                    </p>
                ...
                <div class="row align-items-center">
                    <div class="col-md-6 col-lg-6 col-xl-5">
                        ...
                        <div class="section-title">
                            ...
                            <p class="section-sub-heading">CHOOSE FROM OUR ONLINE VIDEO COURSES WITH NEW ADDITIONS</p>
                        </div>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button class="accordion-button font-medium font-18" type="button"
                                        ...
                                        aria-controls="collapse_1">What is the Molhemoon Platform?
                                    </button>
                                </h2>
                                <div id="collapse_1" class="accordion-collapse collapse" aria-labelledby="heading_1"
                                    data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        Molhemoon is a youth initiative to empower young people and keep pace with digital
                                        development
                                        with a complete, secure, web-based training and learning solution that employs a
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button class="accordion-button font-medium font-18" type="button"
                                        ...
                                        aria-controls="collapse_2">Who uses Molhemoon service?
                                    </button>
                                </h2>
                                <div id="collapse_2" class="accordion-collapse collapse" aria-labelledby="heading_2"
                                    data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        Just about anyone who wants to improve employee skills management, increase
                                        knowledge acquisition and retention,
                                        reduce liability through compliance training, or even just complement traditional
                                        classroom
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button class="accordion-button font-medium font-18" type="button"
                                        ...
                                        aria-controls="collapse_3">Can users view which courses and tests they have taken?
                                    </button>
                                </h2>
                                <div id="collapse_3" class="accordion-collapse collapse" aria-labelledby="heading_3"
                                    data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        Yes, your users will see their course completion status and check course progress
                                        and their current results on tests.
                                    </div>
                                </div>
                            </div>
                        </div>

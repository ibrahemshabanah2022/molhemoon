                                                ...
                                                <div class="sidebar-radio-item">
                                                    <div class="form-check">
                                                        <input class="form-check-input filterDifficultyLevel"
                                                            type="checkbox" name="category_ids[]" onclick="filterData()"
                                                            value="{{ $category->id }}"
                                                            id="exampleRadios{{ $category->id }}">
                                                        <label class="form-check-label"
                                                            for="exampleRadios{{ $category->id }}">
                                                            {{ $category->name }}
                                                        </label>
                                                    </div>
                                        ...
                                        <div class="accordion-body">
                                            ...
                                            <div class="range-value-box">
                                                <div class="range-value-wrap"><label for="price-min">$Min:</label><input
                                                        disabled type="number" min=0 value=0 id="price-min"
                                                        name="price_min" class="price-range-field" /></div>
                                                <div class="range-value-wrap"><label for="price-max">$Max:</label><input
                                                        disabled type="number" max="{{ $priceMax }}"
                                                        value="{{ $priceMax }}" name="price_max" id="price-max"

            ...
            <div class="row footer-top-part section-p-t-b-90">
                <div class="col-12 col-sm-6 col-md-6 col-lg-3">
                    <div class="footer-widget footer-about">
                        <img src="{{ asset('frontend/assets/img/preloader-removebg-preview.png') }}" alt="Logo"
                        ...
                        <div class="footer-social mt-30">
                            <ul class="d-flex align-items-center">
                                @if (get_option('facebook_url'))
                                    <li><a href="https://web.facebook.com/Molhemoon"><span class="iconify"
                                ...
                                @if (get_option('linkedin_url'))
                                    <li><a href="https://www.linkedin.com/company/molhemoon/posts/?feedView=all"><span
                                                class="iconify" data-icon="ant-design:linkedin-filled"></span></a></li>
                                @endif
                                @if (get_option('pinterest_url'))
                                    <li><a
                                            href="https://www.tiktok.com/@molhemoon?fbclid=IwZXh0bgNhZW0CMTAAAR0kdt_BnYju0IEMLPQ2XdaVy3uz_OuzH3Gc71wa3jqgmQTIE4u4flTJE10_aem_AcrFquyMKENGoYo2RFVwktXU5ZHjIQYnmml-M_sKpWtA-RxykMhp6noZ5cL7y-01k3QL5a3tM0axw88Le6bypQOX"><span
                                                class="iconify" data-icon="iconoir:tiktok" data-width="1em"
                                                data-height="1em"></span>
                                        </a>
                                    </li>
                                @endif
                                @if (get_option('pinterest_url'))
                                    <li><a href="https://www.instagram.com/molhemoon.eg/"><span class="iconify"
                        ...
                        <div class="footer-links d-flex">
                            <ul>
                                ...
                                <li><span class="iconify" data-icon="ic:round-email"></span><a
                                        href="mailto:{{ get_option('app_email') }}">molhemoon.misr@gmail.com</a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="row copyright-wrapper">
                ...
                <div class="col-12 col-md-12 col-lg-4">
                    <div class="copyright-text text-center">
                        <p class="text-white font-13"> All Rights Reserved.</p>
                    </div>
                </div>

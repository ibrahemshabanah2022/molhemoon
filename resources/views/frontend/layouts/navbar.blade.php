            ...
            <div class="main-menu-collapse collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="header-nav-right-side d-flex">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('molhemoon.internships') }}"
                                class="nav-link">{{ __('Molhemoon Internships') }}</a>
                        </li>
                        <li class="nav-item">
                                    ...
                                    <div class="dropdown-menu-profile dropdown-menu {{ $selectedLanguage->rtl == 1 ? 'dropdown-menu-start' : 'dropdown-menu-end' }}"
                                        ...
                                        @if (@$authUser->role != USER_ROLE_ADMIN)
                                            ...
                                            <ul class="user-dropdown-item-box">
                                                ...
                                                {{-- @if (Auth::user()->role == USER_ROLE_STUDENT || Auth::user()->is_affiliator == AFFILIATOR || (Auth::user()->role == USER_ROLE_INSTRUCTOR && @$authUser->instructor->status == STATUS_APPROVED) || (Auth::user()->role == USER_ROLE_ORGANIZATION && @$authUser->organization->status == STATUS_APPROVED))
                                                    <li>

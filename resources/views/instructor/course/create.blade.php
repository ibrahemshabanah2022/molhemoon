                        ...
                        <div id="msform">
                            ...
                            <div class="upload-course-step-item upload-course-overview-step-item">
                                ...
                                <div id="upload-course-overview-1">
                                    <form method="POST" action="{{ route('instructor.course.store') }}"
                                        enctype="multipart/form-data" id="step1" class="row g-3 needs-validation"
                                        novalidate>
                                        @csrf
                                        ...
                                        <div class="upload-course-item-block course-overview-step1 radius-8">
                                            ...
                                            <div class="row mb-30">
                                                <div class="col-md-12">
                                                    ...
                                                    <textarea class="form-control" name="subtitle" cols="30" rows="10" required
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mb-30">
                                                    <label
                                                        class="font-medium font-15 color-heading">{{ __('Meta Title') }}</label>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mb-30">
                                                    <label
                                                        class="font-medium font-15 color-heading">{{ __('Meta Description') }}</label>
                                                    <textarea class="form-control" name="meta_description" id="exampleFormControlTextarea1" rows="3"
                                                        placeholder="{{ __('Type Meta Description') }}"></textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mb-30">
                                                    <label
                                                        class="font-medium font-15 color-heading">{{ __('Meta Keywords') }}</label>

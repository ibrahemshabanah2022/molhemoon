                                    ...
                                    <div id="upload-course-overview-2">
                                                    ...
                                                    <select name="category_id" id="category_id" class="form-select"
                                                        ...
                                                        @foreach ($categories as $category)
                                                            <option value="{{ $category->id }}"
                                                                @if (old('category_id')) {{ old('category_id') == $category->id ? 'selected' : '' }} @else
                                                        {{ $course->category_id == $category->id ? 'selected' : '' }} @endif>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mb-30">
                                                    ...
                                                    <select name="tag[]" class="select2" multiple>
                                                        @foreach ($tags as $tag)
                                                            <option value="{{ $tag->id }}"
                                                                @if (in_array($tag->id, $selected_tags)) selected @endif>
                                                                {{ $tag->name }}</option>
                                                        @endforeach
                                                    </select>
                                        ...
                                        <div class="upload-course-item-block course-overview-step1 radius-8">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mb-30">
                                                    <label
                                                        class="label-text-title color-heading font-medium font-16 mb-3">{{ __('Request course as') }}
                                                    </label>
                                                    <select name="status" class="form-select status" required>
                                                        @php
                                                            $status = old('status', $course->status);
                                                        @endphp
                                                        <option value="{{ STATUS_UPCOMING_REQUEST }}"
                                                            {{ in_array($status, [STATUS_UPCOMING_REQUEST, STATUS_UPCOMING_APPROVED]) ? 'selected' : '' }}>
                                                            {{ __('Upcoming') }}</option>
                                                        <option value="{{ STATUS_APPROVED }}"
                                                            {{ in_array($status, [STATUS_APPROVED, STATUS_REJECTED, STATUS_HOLD, STATUS_SUSPENDED, STATUS_DELETED]) ? 'selected' : '' }}>
                                                            {{ __('Publish') }}</option>
                                                    </select>
                                                    <div class="form-text">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mb-30">
                                                    ...
                                                    <select name="learner_accessibility"
                                                        ...
                                                        <option value="paid"
                                                            @if (old('learner_accessibility')) {{ old('learner_accessibility') == 'paid' ? 'selected' : '' }}
                                                        @else {{ $course->learner_accessibility == 'paid' ? 'selected' : '' }} @endif>
                                                            {{ __('Paid') }}</option>
                                                        <option value="free"
                                                            @if (old('learner_accessibility')) {{ old('learner_accessibility') == 'free' ? 'selected' : '' }}
                                                        @else {{ $course->learner_accessibility == 'free' ? 'selected' : '' }} @endif>
                                                            {{ __('Free') }}</option>
                                                    </select>
                                                </div>
                                            </div>
                                                    ...
                                                    <select name="course_language_id" id="course_language_id"
                                                        ...
                                                        @foreach ($course_languages as $course_language)
                                                            <option value="{{ $course_language->id }}"
                                                                @if (old('course_language_id')) {{ old('course_language_id') == $course_language->id ? 'selected' : '' }} @else {{ $course->course_language_id == $course_language->id ? 'selected' : '' }} @endif>
                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-md-6 mb-30">
                                                    <div class="upload-img-box mt-3 height-200">
                                                        ...
                                                        <input type="file" name="image" id="image"
                                                            ...
                                                            @if (!$course->image) required @endif>
                                                ...
                                                <div class="col-md-6 mb-30">
                                                    <p class="font-14 color-gray">
                                                        {{ __('Recomended image format & size') }}:
                                                        575px X 450px (1MB)</p>
                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-md-12 mb-30">
                                                    <input type="radio"
                                                        {{ $course->intro_video_check == 1 ? 'checked' : '' }}
                                                        id="video_check" class="intro_video_check"
                                                        name="intro_video_check" value="1">
                                                    <label for="video_check">{{ __('Video Upload') }}</label><br>
                                                    <input type="radio"
                                                        {{ $course->intro_video_check == 2 ? 'checked' : '' }}
                                                        id="youtube_check" class="intro_video_check"
                                                        name="intro_video_check" value="2">
                                                    <label for="youtube_check">{{ __('Youtube Video') }}
                                                        ({{ __('write only video Id') }})</label><br>
                                                </div>
                                                <div class="col-md-12 mb-30">
                                                    <input type="file" name="video" id="video"
                                                        accept="video/mp4" class="form-control d-none">

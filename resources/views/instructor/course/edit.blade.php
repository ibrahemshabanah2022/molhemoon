                            ...
                            <div class="upload-course-step-item upload-course-overview-step-item">
                                ...
                                <div id="upload-course-overview-1">
                                    <form method="POST" action="{{ route('course.update.overview', [$course->uuid]) }}"
                                        id="step1" enctype="multipart/form-data" class="row g-3 needs-validation"
                                        novalidate>
                                        @csrf
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mb-30">
                                                    ...
                                                    <input type="text" name="meta_title"
                                                        value="{{ $course->meta_title }}" class="form-control"
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mb-30">
                                                    ...
                                                    <textarea class="form-control" name="meta_description" id="exampleFormControlTextarea1" rows="3"
                                                        placeholder="{{ __('Type Meta Description') }}">{{ $course->meta_description }}</textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mb-30">
                                                    ...
                                                    <input type="text" name="meta_keywords"
                                                        value="{{ $course->meta_keywords }}" class="form-control"

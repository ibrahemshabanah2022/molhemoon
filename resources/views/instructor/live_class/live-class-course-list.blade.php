                                            ...
                                            <td>
                                                <div class="table-data-with-img d-flex align-items-center">
                                                    <div class="flex-shrink-0">
                                                        <div class="table-data-img-wrap"><img
                                                                src="{{ getImageFile($course->image_path) }}" alt="img"
                                                                class="img-fluid"></div>
                                                    </div>
                                            ...
                                            <td>
                                                <div class="notice-board-action-btns">
                                                    <a href="{{ route('live-class.create', [$course->uuid]) }}"
                                                        class="theme-btn theme-button1 default-hover-btn">{{ __('Create Live Class') }}</a>
                                                    <a href="{{ route('live-class.index', [$course->uuid]) }}"
                                                        class="theme-btn theme-button1 green-theme-btn default-hover-btn">{{ __('View') }}
                                                        List</a>
                                                </div>
                                            </td>
                                        </tr>
